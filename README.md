...
| `VITE_AI_GATEWAY_BASE_URL` | Base pública del gateway de IA en QA (`https://qa.api.idempotencia.andrescortes.dev`), ver [Integración con backend](#integración-con-backend). Sin definir, los ejemplos de uso muestran un placeholder. |
